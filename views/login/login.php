...
<body>
    <div class="container">
        <div class="card">
            <h1 class="card_title">Đăng nhập</h1>
            <p class="card_title-info">Muakey.com</p>
            <?php if (!empty($loginError)): ?>
                <p style="color: #ff5050; text-align: center; margin-bottom: 16px; font-size: 14px;"><?php echo htmlspecialchars($loginError); ?></p>
            <?php endif; ?>
            <form class="card_form" method="POST" action="/">
                <input type="hidden" name="action" value="login">
                <div class="input">
                    <input type="text" name="username" class="input_field" required />
                    <label class="input_label">Tài khoản</label>
                </div>
                <div class="input">
