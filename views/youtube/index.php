                                                                                                                                ...
                                                                                                                                <tr>
                                                                                                                                        ...
                                                                                                                                        <td>
                                                                                                                                                <div
                                                                                                                                                        ...
                                                                                                                                                        <a class="leading-none font-medium text-sm text-mono hover:text-primary"
                                                                                                                                                                href="#">
                                                                                                                                                                <?php echo date('d/m/Y', strtotime($family['payment_at'])) ?>
                                                                                                                                                        </a>
                                                                                                                                                </div>
                                                                                                                                        </td>
                                                                                                                                        <td>
                                                                                                                                        ...
                                                                                                                                        <td>
                                                                                                                                                <div
                                                                                                                                                        ...
                                                                                                                                                        <a class="leading-none font-medium text-sm text-mono hover:text-primary"
                                                                                                                                                                href="#">
                                                                                                                                                                <?php echo date('d/m/Y', timestamp: strtotime($family['pay_due_date'])) ?>
                                                                                                                                                        </a>
                                                                                                                                                </div>
                                                                                                                                        </td>
                                                                                                                                        <td>
                                                                                                                                        ...
                                                                                                                                        ?>
                                                                                                                                                <td>
                                                                                                                                                        <div
                                                                                                                                                                ...
                                                                                                                                                                <a class="leading-none font-medium text-sm text-mono hover:text-primary"
                                                                                                                                                                        href="#">
                                                                                                                                                                        <?php echo isset($member['order_code']) ? "Mã đơn hàng: " . htmlspecialchars($member['order_code']) : "Thành viên " . $i; ?>
                                                                                                                                                                </a>
                                                                                                                                                                <button
                                                                                                                                                                        type="button"
                                                                                                                                                                        class="text-2sm text-primary font-normal leading-3 hover:underline cursor-pointer text-left member-view-btn"
