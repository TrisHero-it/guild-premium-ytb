                        ...
                        <div class="grid">
                            <div class="kt-card kt-card-grid h-full min-w-full">
                                ...
                                <div class="kt-card-body">
                                    ...
                                    <form method="POST" action="/" id="add_family_form" enctype="multipart/form-data" class="grid gap-5 lg:gap-7.5">
                                        ...
                                        <div class="grid lg:grid-cols-2 gap-5" style="padding: 0 10px;">
                                            <div class="flex flex-col gap-2">
                                                ...
                                                <label class="kt-input">
                                                    ...
                                                    <input type="text" name="user" placeholder="Nguyễn Văn A" required>
                                                </label>
                                            </div>
                                            <div class="flex flex-col gap-2">
                                                <label class="kt-form-label text-mono font-semibold text-sm">
                                                ...
                                                <label class="kt-input">
                                                    ...
                                                    <input type="tel" name="number_phone" placeholder="0347895560">
                                                </label>
                                            </div>
                                        </div>
                                        ...
                                        <div class="grid lg:grid-cols-2 gap-5" style="padding: 0 10px;">
                                            <div class="flex flex-col gap-2">
                                                ...
                                                <label class="kt-input">
                                                    ...
                                                    <input type="text" name="number_bank" placeholder="19073432582017" required>
                                                </label>
                                            </div>
                                            <div class="flex flex-col gap-2">
                                                <label class="kt-form-label text-mono font-semibold text-sm">
                                        ...
                                        <div class="grid lg:grid-cols-2 gap-5" style="padding: 0 10px;">
                                            <div class="flex flex-col gap-2">
                                                ...
                                                <label class="kt-input">
                                                    ...
                                                    <input type="date" name="payment_at">
                                                </label>
                                            </div>
                                            <div class="flex flex-col gap-2">
                                                <label class="kt-form-label text-mono font-semibold text-sm">
                                        ...
                                        <div class="flex flex-col gap-2" style="padding: 0 10px;">
                                            ...
                                            <div class="flex flex-col gap-2">
                                                ...
                                                <button type="button" id="clear_all_bill_master_files" class="kt-btn kt-btn-sm kt-btn-ghost hidden mt-1" onclick="clearBillOfMasterPreview()">Xóa tất cả</button>
                                            </div>
                                        </div>
                                        ...
                                        <div class="flex flex-col gap-2" style="padding: 0 10px;">
                                            ...
                                            <textarea name="note" class="kt-textarea" rows="4" placeholder="Nhập ghi chú (nếu có)"></textarea>
                                        </div>
