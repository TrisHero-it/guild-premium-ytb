...
<body class="antialiased flex h-full text-base text-foreground bg-background demo1 kt-sidebar-fixed kt-header-fixed">
                                ...
                                <div class="grid">
                                    <div
                                        ...
                                        <div class="kt-card-header">
                                            ...
                                            <div class="flex items-center gap-2">
                                                <a href="?act=collaborators&sub=add" class="kt-btn kt-btn-primary">
                                                                ...
                                                                <tr>
                                                                    <td colspan="4" class="text-center py-10">
                                                                        <div class="flex flex-col items-center gap-2">
                                                                            <i class="ki-filled ki-information text-muted-foreground text-4xl"></i>
                                                                            <span class="text-sm text-secondary-foreground">Chưa có dữ liệu</span>
                                                                        </div>
                                                                    </td>
                                                                </tr>
                                                            <?php else: ?>
                                                                <?php foreach ($collaborators as $collaborator): ?>
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <div class="flex items-center gap-2">
                                                                                <a class="kt-btn kt-btn-icon kt-btn-sm kt-btn-ghost"
                                                                                    href="?act=collaborators&sub=edit&id=<?php echo $collaborator['id']; ?>"
                                                                                    title="Sửa">
                                                                                    <i class="ki-filled ki-pencil text-primary">
                                                                                    </i>
                                                                                </a>
                                                                                <button class="kt-btn kt-btn-icon kt-btn-sm kt-btn-ghost"
                                                                                    onclick="deleteCollaborator(<?php echo $collaborator['id']; ?>)"
                                                                                    title="Xóa">
                                                                        ...
                                                                        <td>
                                                                            <div class="flex flex-col gap-2">
                                                                                <div class="text-sm text-foreground line-clamp-2">
                                                                                    <?php
                                                                                    $content = strip_tags($collaborator['content']);
                                                                        ...
                                                                        <td>
                                                                            <div class="flex flex-col gap-2">
                                                                                <?php
                                                                                $statusClass = $collaborator['status'] === 'active' ? 'kt-badge-success' : 'kt-badge-destructive';
                                                                                $statusText = $collaborator['status'] === 'active' ? 'Hoạt động' : 'Không hoạt động';
                                                                                ?>
                                                                                <span class="kt-badge <?php echo $statusClass; ?>">
                                                                                    <?php echo $statusText; ?>
                                                                                </span>
                                                                            </div>
                                                                        </td>
    ...
    <script>
        ...
        function deleteCollaborator(id) {
            if (confirm('Bạn có chắc chắn muốn xóa collaborator này không?')) {
                ...
                actionInput.value = 'delete-collaborator';
